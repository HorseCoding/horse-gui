...
module.exports = [
    ...
    defaultsDeep({}, base, {
        entry: {
            ...
            'dev-settings': './src/playground/devSettings/devSettings.jsx'
        },
        output: {
        ...
        plugins: base.plugins.concat([
            ...
            new HtmlWebpackPlugin({
                ...
                template: 'src/playground/index.ejs',
                filename: 'index.html',
                title: 'Espresso - A mod of PenguinMod',
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['fullscreen'],
                ...
                title: 'Espresso - Build amazing projects',
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['embed'],
                template: 'src/playground/index.ejs',
                filename: 'embed.html',
                title: 'Embedded Project - Espresso',
                noTheme: true,
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
            ...
            new HtmlWebpackPlugin({
                ...
                title: 'Espresso, PenguinMod, and TurboWarp Credits',
                noSplash: true,
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['dev-settings'],
                template: 'src/playground/simple.ejs',
                filename: 'devsettings.html',
                title: 'Espresso - Development Settings',
                noSplash: true,
                ...htmlWebpackPluginCommon
            }),
